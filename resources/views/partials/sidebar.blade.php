...
<aside class="sidebar" id="app-sidebar" aria-label="Menu navigasi utama">
    ...
    <nav class="sidebar-menu">
        @if($role === 'admin')
            ...
            <a class="sidebar-menu-item {{ request()->routeIs('kategorisasi-kriteria.*') ? 'active' : '' }}" href="{{ route('kategorisasi-kriteria.index') }}"><i class="bi bi-folder2-open"></i> Kategorisasi Kriteria</a>
